...
#SBATCH --output=/xdisk/chanc/ram/outputs/case1/athena_case1.out
#SBATCH --error=/xdisk/chanc/ram/outputs/case1/athena_case1.err
#SBATCH --verbose
...
mkdir -p /xdisk/chanc/ram/outputs/case1
cd /xdisk/chanc/ram/outputs/case1
...
srun -n 2 /xdisk/chanc/ram/AthenaK_research/gpu/puma/volta70/build-gpu-torus-mad-volta70/src/athena \
    -i /xdisk/chanc/ram/AthenaK_research/inputs/grmhd/gr_fm_torus_mad_long_case1.athinput
