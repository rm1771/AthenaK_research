...
#SBATCH --output=/xdisk/chanc/ram/outputs/case4/athena_case4.out
#SBATCH --error=/xdisk/chanc/ram/outputs/case4/athena_case4.err
#SBATCH --verbose
...
srun -n 2 /xdisk/chanc/ram/AthenaK_research/gpu/puma/volta70/build-gpu-torus-mad-volta70/src/athena \
    -i /xdisk/chanc/ram/AthenaK_research/inputs/grmhd/gr_fm_torus_mad_long_case4.athinput
